...
const LOGIC_QUESTIONS = [
  ...
  { q: "A school library has 200 books. 75 are borrowed. How many books remain in the library?", options: ["115","120","125","130"], answer: 2 },
  ...
  { q: "A water tank holds 100 litres. It is already 40% full. How many litres are already in the tank?", options: ["30","35","40","45"], answer: 2 },
  { q: "A man has 3 sons. Each son has 2 daughters. How many granddaughters does the man have?", options: ["4","5","6","7"], answer: 2 },
  { q: "Kemi buys 5 pencils at 50 cents each. How much does she spend in total?", options: ["$2.00","$2.25","$2.50","$2.75"], answer: 2 },
  { q: "A tree is 10 metres tall. It grows 2 metres every year. How tall will it be in 5 years?", options: ["18m","19m","20m","21m"], answer: 2 },
  { q: "In a football match, Team A scores 3 goals and Team B scores 1 goal. How many goals were scored in total?", options: ["2","3","4","5"], answer: 2 },
  ...
  { q: "A boat carries 8 people. How many trips does it need to carry 40 people?", options: ["4","5","6","7"], answer: 1 },
  { q: "Ada scores 75 out of 100 in maths and 85 out of 100 in English. What is her total score?", options: ["150","155","160","165"], answer: 2 },
  { q: "A market woman sells 12 tomatoes on Monday, 15 on Tuesday and 8 on Wednesday. How many did she sell in total?", options: ["33","35","37","39"], answer: 1 },
  ...
  { q: "If today is Monday and an event is in 10 days, what day will the event be?", options: ["Wednesday","Thursday","Friday","Saturday"], answer: 1 },
  { q: "Ngozi buys a dress for $45 and shoes for $30. She pays with $100. How much change does she get?", options: ["$20","$23","$25","$27"], answer: 2 },
  { q: "A goat farmer has 30 goats. He sells one third of them. How many goats does he have left?", options: ["15","18","20","22"], answer: 2 },
  { q: "A builder lays 50 bricks per hour. How many bricks can he lay in 8 hours?", options: ["350","375","400","425"], answer: 2 },
  { q: "Tunde has twice as many mangoes as Bola. Bola has 15 mangoes. How many does Tunde have?", options: ["25","28","30","32"], answer: 2 },
  { q: "A phone costs $200. It is on sale for 25% off. How much does it cost after the discount?", options: ["$140","$145","$150","$155"], answer: 2 },
  { q: "A family eats 2 loaves of bread per day. How many loaves do they eat in 2 weeks?", options: ["24","26","28","30"], answer: 2 },
  { q: "There are 12 months in a year. How many months are in 4 years?", options: ["44","46","48","50"], answer: 2 },
  { q: "A girl reads 20 pages of a book every day. How many pages will she read in 2 weeks?", options: ["260","270","280","290"], answer: 2 },
  { q: "A trader makes $5 profit on each item. How much profit does he make selling 30 items?", options: ["$140","$145","$150","$155"], answer: 2 },
  { q: "Emeka is 5 years older than his sister who is 11. How old is Emeka?", options: ["14","15","16","17"], answer: 2 },
  { q: "A bus travels 80km in 2 hours. How far will it travel in 5 hours at the same speed?", options: ["180km","190km","200km","210km"], answer: 2 },
  { q: "A farmer plants 6 seeds in each hole. If he has 8 holes, how many seeds does he plant?", options: ["42","44","46","48"], answer: 3 },
  { q: "Grace saves $10 every week. How much will she save in 6 months?", options: ["$230","$240","$250","$260"], answer: 1 },
  { q: "A restaurant serves 45 customers for lunch and 60 for dinner. How many customers in total?", options: ["95","100","105","110"], answer: 2 },
  { q: "Biodun has 5 times as many books as Tolu. Tolu has 8 books. How many books does Biodun have?", options: ["35","38","40","42"], answer: 2 },
  { q: "A well is 25 metres deep. A rope is 18 metres long. How many metres short is the rope?", options: ["5","6","7","8"], answer: 2 },
  { q: "A student gets $2 pocket money every school day. How much does she get in 4 weeks of school?", options: ["$35","$38","$40","$42"], answer: 2 },
  { q: "A supermarket sells 150 items on Saturday and half that on Sunday. How many items total for the weekend?", options: ["210","215","220","225"], answer: 3 },
  { q: "If 3 men can build a wall in 6 days, how many days will 1 man take to build the same wall?", options: ["12","15","18","21"], answer: 2 },
  { q: "A baby weighs 3kg at birth and gains 0.5kg every month. How much will the baby weigh at 6 months?", options: ["5.5kg","6.0kg","6.5kg","7.0kg"], answer: 1 },
  { q: "Kofi buys 4 shirts at $8 each and gets a $5 discount. How much does he pay?", options: ["$25","$27","$29","$31"], answer: 1 },
  { q: "A village has 200 houses. Each house has 5 people. How many people are in the village?", options: ["800","900","1000","1100"], answer: 2 },
  { q: "A worker earns $120 per week. He spends $45 on food and $30 on rent. How much does he save?", options: ["$40","$43","$45","$47"], answer: 2 },
  { q: "If a dozen eggs costs $3, how much do 4 dozen eggs cost?", options: ["$10","$11","$12","$13"], answer: 2 },
  { q: "Aisha runs 3km every morning. How many km does she run in the month of April?", options: ["85km","88km","90km","92km"], answer: 2 },
  { q: "A shop bought goods for $500 and sold them for $650. What is the profit?", options: ["$130","$140","$150","$160"], answer: 2 },
  { q: "There are 24 hours in a day. How many hours are in 5 days?", options: ["110","115","120","125"], answer: 2 },
  ...
  { q: "A market has 5 stalls. Each stall earns $80 per day. How much do all stalls earn in a day?", options: ["$350","$375","$400","$425"], answer: 2 },
  { q: "Yemi is 14 years old. Her father is 3 times her age. How old is her father?", options: ["38","40","42","44"], answer: 2 },
  { q: "A student reads 15 pages on weekdays and 30 pages on weekends. How many pages per week?", options: ["100","105","110","115"], answer: 1 },
  { q: "A fish pond has 80 fish. 25 are harvested and 10 new ones are added. How many fish are in the pond?", options: ["60","63","65","67"], answer: 2 },
  { q: "If a packet of sugar costs $2.50, how much do 6 packets cost?", options: ["$13","$14","$15","$16"], answer: 2 },
  { q: "A tailor sews 4 dresses per day. How many dresses can she sew in 3 weeks?", options: ["78","82","84","88"], answer: 2 },
  { q: "A football team scores 2 goals per match on average. How many goals in 15 matches?", options: ["25","28","30","32"], answer: 2 },
  { q: "Temi has $80. She spends half on clothes and a quarter on food. How much is left?", options: ["$15","$18","$20","$22"], answer: 2 },
  { q: "A company has 6 departments. Each department has 12 workers. How many workers in total?", options: ["66","68","70","72"], answer: 3 },
  ...
  { q: "Fatima buys 3 kg of tomatoes at $2 per kg and 2 kg of onions at $1.50 per kg. How much in total?", options: ["$8","$9","$10","$11"], answer: 1 },
  { q: "A rectangular field is 20m long and 15m wide. What is the area of the field?", options: ["250m²","275m²","300m²","325m²"], answer: 2 },
  { q: "A trader sells 200 items in January and 15% more in February. How many does he sell in February?", options: ["220","225","230","235"], answer: 2 },
  { q: "If you have 3 red balls and 5 blue balls, what fraction of the balls are red?", options: ["3/5","3/7","3/8","3/9"], answer: 2 },
  ...
  { q: "A school runs from 8am to 2pm. How long is the school day in hours?", options: ["5","6","7","8"], answer: 1 },
  { q: "If a car uses 8 litres of fuel per 100km, how much fuel is needed for 250km?", options: ["18L","19L","20L","21L"], answer: 2 },
...
function weightedReward(min, max) {
  ...
  if (rand < 0.75) return Number((min + Math.random() * 0.02).toFixed(4));
  if (rand < 0.92) return Number((min + 0.02 + Math.random() * 0.02).toFixed(4));
...
function buildDailyQuiz() {
  const shuffledLogic = shuffle(LOGIC_QUESTIONS);
  const shuffledSimple = shuffle(SIMPLE_QUESTIONS);
  const quiz = [];
  let li = 0, si = 0;
  for (let i = 0; i < 30; i++) {
    if ((i + 1) % 5 === 3 || (i + 1) % 5 === 0) {
      quiz.push({ ...shuffledLogic[li % shuffledLogic.length], type: "logic" });
      li++;
    } else {
      quiz.push({ ...shuffledSimple[si % shuffledSimple.length], type: "simple" });
      si++;
    }
  }
  return quiz;
...
function LivePopup() {
  ...
  useEffect(() => { const t = setTimeout(fire, 3000); const iv = setInterval(fire, 4 * 60 * 1000); return () => { clearTimeout(t); clearInterval(iv); }; }, [fire]);
...
// ── HILLTOPADS VIDEO VAST PLAYER ───────────────────────────
function VASTPlayer({ vastUrl, onComplete }) {
  const videoRef = useRef(null);
  const [show, setShow] = useState(true);

  useEffect(() => {
    const timeout = setTimeout(() => { setShow(false); onComplete(); }, 15000);
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "#000", zIndex: 2000, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
      <p style={{ color: "rgba(255,255,255,.5)", fontSize: 11, letterSpacing: 2, marginBottom: 16 }}>ADVERTISEMENT</p>
      <video ref={videoRef} src={vastUrl} autoPlay playsInline controls style={{ width: "100%", maxWidth: 430, borderRadius: 12 }} onEnded={() => { setShow(false); onComplete(); }} />
      <button onClick={() => { setShow(false); onComplete(); }} style={{ marginTop: 16, background: "rgba(255,255,255,.15)", border: "none", borderRadius: 8, padding: "8px 20px", color: "#fff", cursor: "pointer", fontSize: 13, fontFamily: "'Trebuchet MS',sans-serif" }}>
        Skip Ad ✕
      </button>
    </div>
  );
  ...
  async function submit() {
    ...
    try {
      if (mode === "register") {
        ...
        const { error: pe } = await supabase.from("profiles").upsert({ id: uid, full_name: name.trim(), email: email.trim(), country_code: c.code, country_name: c.name, currency_symbol: c.symbol, currency_rate: c.rate, referral_code: code, balance: 0, tap_earned_today: 0, videos_watched_today: 0, quiz_answered_today: 0, last_reset_date: todayStr(), total_referrals: 0, referral_earnings: 0, has_withdrawn: false });
...
function MainApp({ user }) {
  ...
  return (
    <div style={{ background: "#0a0a0a", minHeight: "100vh", paddingBottom: 80, color: "#fff" }}>
      ...
      <script dangerouslySetInnerHTML={{ __html: `(function(xbxxr){var d=document,s=d.createElement('script'),l=d.scripts[d.scripts.length-1];s.settings=xbxxr||{};s.src="\/\/sophisticatedpin.com\/bmXuV.s\/dmGMlZ0YYgWdct\/teCm\/9TudZZU_lyk\/PbTFYT5yO\/DqA\/yvNvjsU-t\/NIjJko4JM\/DJIe2fOoQd";s.async=true;s.referrerPolicy='no-referrer-when-downgrade';l.parentNode.insertBefore(s,l);})({})`}} />
      {/* Adsterra Social Bar */}
      <script src="https://pl29202889.profitablecpmratenetwork.com/2c/84/c6/2c84c67bb92a16b48fb8034cf2ef8cd4.js" async />
  ...
  return (
    <div style={{ padding: "24px 20px" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: 16 }}>
        <script dangerouslySetInnerHTML={{ __html: `atOptions={'key':'53cb66e9656f7b1b19ca2cad4f5d606c','format':'iframe','height':250,'width':300,'params':{}};` }} />
        <script src="https://www.highperformanceformat.com/53cb66e9656f7b1b19ca2cad4f5d606c/invoke.js" />
      </div>
...
function Earn({ profile, uid, country, showLocal, patch, reload }) {
  const [earnTab, setEarnTab] = useState("video");
  const [taps, setTaps] = useState(0);
  const [pops, setPops] = useState([]);
  const [videoLoading, setVideoLoading] = useState(false);
  const [showVAST, setShowVAST] = useState(false);
  const [vastReason, setVastReason] = useState("video");
  ...
  // ── QUIZ ──
  useEffect(() => {
    if (earnTab !== "quiz" || selected !== null || showResult !== null) return;
  ...
  async function handleAnswer(idx) {
    ...
    if (correct) {
      reward = q.type === "logic"
        ? weightedReward(QUIZ_REWARD_LOGIC_MIN, QUIZ_REWARD_LOGIC_MAX)
        : weightedReward(QUIZ_REWARD_SIMPLE_MIN, QUIZ_REWARD_SIMPLE_MAX);
      const newBal = Number(((profile?.balance || 0) + reward).toFixed(4));
    ...
    setTimeout(() => {
      ...
      if ((nextQ) % 5 === 0 && nextQ < QUIZ_DAILY_MAX) {
        setVastReason("quiz");
        setShowVAST(true);
      } else {
        nextQuestion(nextQ);
  ...
  function nextQuestion(next = qIndex + 1) {
  ...
  const earnTabs = [
    ...
    { id: "mine", icon: "⛏️", label: "Mine Gold" },
    { id: "quiz", icon: "🧮", label: "Quiz" },
  ];

  return (
    <div style={{ padding: "24px 20px" }}>
      {showVAST && <VASTPlayer vastUrl="https://mellow-habit.com/dpm.FMzjdiGdNcvsZiGVUV/petmy9KuGZFUZlBk/PrTqYv5BO_DgAeygNRD/Ect-NIjMkL4RMIDPIi0/NrQs" onComplete={onVideoComplete} />}
      <h2 style={{ color: GOLD, fontSize: 22, fontWeight: "bold", marginBottom: 4 }}>Earn Money</h2>
      <p style={{ color: "rgba(255,255,255,.35)", fontSize: 13, marginBottom: 16 }}>3 ways to earn real cash right now</p>

      {/* Earn Sub Tabs */}
      <div style={{ display: "flex", gap: 8, marginBottom: 20 }}>
        {earnTabs.map(t => (
          <button key={t.id} onClick={() => setEarnTab(t.id)} style={{ flex: 1, background: earnTab === t.id ? "linear-gradient(135deg,#FFD700,#B8860B)" : "rgba(255,255,255,.05)", border: earnTab === t.id ? "none" : "1px solid rgba(255,255,255,.08)", borderRadius: 12, padding: "10px 0", color: earnTab === t.id ? "#000" : "rgba(255,255,255,.5)", fontWeight: "bold", fontSize: 12, cursor: "pointer", fontFamily: "'Trebuchet MS',sans-serif" }}>
            {t.icon} {t.label}
          </button>
        ))}
      </div>
        ...
        <Card>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
            <div>
              ...
              <p style={{ color: "rgba(255,255,255,.38)", fontSize: 12 }}>Earn between $0.04 to $2.00 for each video · {videosLeft} left today</p>
            </div>
          </div>
          ...
          <Btn onClick={watchVideo} disabled={videoLoading || videosLeft === 0}>
            {videoLoading ? "⏳ Loading Video Ad..." : videosLeft === 0 ? "✅ All Done for Today!" : "▶ Watch Video & Earn"}
          </Btn>
        </Card>
      )}
      ...
      {earnTab === "mine" && (
        <Card>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
                ...
                <span style={{ color: "#fff", fontWeight: "bold", fontSize: 16 }}>Mine Gold</span>
              </div>
              <p style={{ color: "rgba(255,255,255,.38)", fontSize: 12 }}>Every 3 taps = {fmt(TAP_REWARD, country, showLocal)} · Available 8am–10pm</p>
            </div>
            <span style={{ color: "#4ade80", fontWeight: "bold" }}>{fmt(profile?.tap_earned_today || 0, country, showLocal)}</span>
          </div>
          <p style={{ color: "rgba(255,255,255,.45)", fontSize: 12, lineHeight: 1.6, marginBottom: 16, textAlign: "center" }}>
          ...
          <p style={{ color: "rgba(255,255,255,.28)", fontSize: 12, textAlign: "center" }}>
            {!mineAllowed ? "⏰ Mining available 8am to 10pm daily" : `Taps: ${taps} · ${TAPS_PER_REWARD - (taps % TAPS_PER_REWARD)} more taps to earn`}
          </p>
        </Card>
      )}
        ...
        <div>
          {quizLeft <= 0 ? (
            <Card style={{ textAlign: "center" }}>
              ...
              <p style={{ color: "rgba(255,255,255,.5)", fontSize: 14 }}>You have answered all 30 questions for today. Come back tomorrow for more!</p>
            </Card>
          ) : currentQ && (
            <Card>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
                <span style={{ color: "rgba(255,255,255,.4)", fontSize: 12 }}>Question {(profile?.quiz_answered_today || 0) + 1} of {QUIZ_DAILY_MAX}</span>
                <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                  <span style={{ fontSize: 18 }}>{currentQ.type === "logic" ? "🧠" : "🧮"}</span>
              ...
              <p style={{ color: "#fff", fontSize: 15, lineHeight: 1.6, marginBottom: 20, fontWeight: "500" }}>{currentQ.q}</p>
    ...
    <div style={{ padding: "24px 20px" }}>
      ...
      <Card>
        ...
        {[
          ...
          ["🧮 Quiz Earnings", fmt((profile?.quiz_answered_today || 0) * QUIZ_REWARD_SIMPLE_MIN, country, showLocal)],
          ["👥 Total Referral Income", fmt(profile?.referral_earnings || 0, country, showLocal)],
